...
@section('content')
@can('newborn_data_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.newborn-datas.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.newbornData.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.newbornData.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-NewbornData">
            <thead>
                <tr>
                    <th width="10">
...
@can('newborn_data_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.newborn-datas.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.newborn-datas.index') }}",
    columns: [
...
{ data: 'mother_age', name: 'mother_age' },
{ data: 'gravidity', name: 'gravidity' },
{ data: 'parity', name: 'parity' },
{ data: 'accel_x', name: 'accel_x' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-NewbornData').DataTable(dtOverrideGlobals);
