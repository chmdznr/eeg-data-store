...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.newbornData.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.newborn-datas.update", [$newbornData->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="trial_code">{{ trans('cruds.newbornData.fields.trial_code') }}</label>
                <input class="form-control {{ $errors->has('trial_code') ? 'is-invalid' : '' }}" type="text" name="trial_code" id="trial_code" value="{{ old('trial_code', $newbornData->trial_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $newbornData->name) }}">
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mother_name') ? 'is-invalid' : '' }}" type="text" name="mother_name" id="mother_name" value="{{ old('mother_name', $newbornData->mother_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mother_age') ? 'is-invalid' : '' }}" type="number" name="mother_age" id="mother_age" value="{{ old('mother_age', $newbornData->mother_age) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gravidity') ? 'is-invalid' : '' }}" type="number" name="gravidity" id="gravidity" value="{{ old('gravidity', $newbornData->gravidity) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parity') ? 'is-invalid' : '' }}" type="number" name="parity" id="parity" value="{{ old('parity', $newbornData->parity) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('accel_x') ? 'is-invalid' : '' }}" type="number" name="accel_x" id="accel_x" value="{{ old('accel_x', $newbornData->accel_x) }}" step="0.000001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('accel_y') ? 'is-invalid' : '' }}" type="number" name="accel_y" id="accel_y" value="{{ old('accel_y', $newbornData->accel_y) }}" step="0.000001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('accel_z') ? 'is-invalid' : '' }}" type="number" name="accel_z" id="accel_z" value="{{ old('accel_z', $newbornData->accel_z) }}" step="0.000001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thermal') ? 'is-invalid' : '' }}" type="number" name="thermal" id="thermal" value="{{ old('thermal', $newbornData->thermal) }}" step="0.000001">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pulse') ? 'is-invalid' : '' }}" type="number" name="pulse" id="pulse" value="{{ old('pulse', $newbornData->pulse) }}" step="1">
                @if($errors->has('pulse'))
                    <div class="invalid-feedback">
                        {{ $errors->first('pulse') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_2') ? 'is-invalid' : '' }}" type="number" name="spo_2" id="spo_2" value="{{ old('spo_2', $newbornData->spo_2) }}" step="1">
                @if($errors->has('spo_2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('spo_2') }}
                    </div>
