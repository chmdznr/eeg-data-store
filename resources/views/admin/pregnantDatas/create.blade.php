...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pregnantData.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pregnant-datas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gravidity') ? 'is-invalid' : '' }}" type="number" name="gravidity" id="gravidity" value="{{ old('gravidity', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parity') ? 'is-invalid' : '' }}" type="number" name="parity" id="parity" value="{{ old('parity', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}" type="number" name="age" id="age" value="{{ old('age', '30') }}" step="1" required>
                @if($errors->has('age'))
                    <div class="invalid-feedback">
                        {{ $errors->first('age') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hr') ? 'is-invalid' : '' }}" type="number" name="hr" id="hr" value="{{ old('hr', '0') }}" step="1">
                @if($errors->has('hr'))
                    <div class="invalid-feedback">
                        {{ $errors->first('hr') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_2') ? 'is-invalid' : '' }}" type="number" name="spo_2" id="spo_2" value="{{ old('spo_2', '0') }}" step="1">
                @if($errors->has('spo_2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('spo_2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resp_count') ? 'is-invalid' : '' }}" type="number" name="resp_count" id="resp_count" value="{{ old('resp_count', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sistole') ? 'is-invalid' : '' }}" type="number" name="sistole" id="sistole" value="{{ old('sistole', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diastole') ? 'is-invalid' : '' }}" type="number" name="diastole" id="diastole" value="{{ old('diastole', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fetal_hr') ? 'is-invalid' : '' }}" type="number" name="fetal_hr" id="fetal_hr" value="{{ old('fetal_hr', '') }}" step="1">
